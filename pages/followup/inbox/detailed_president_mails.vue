<template>
  <v-container fill-height fluid grid-list-xl dir="rtl" dark>
    ...
    <v-layout justify-center wrap>
      <v-flex md12>
        <material-card color="primary" :title="$t('List_Inbox_Mails')" dir="rtl">
          <v-card-title>
            <v-layout wrap>
              <v-flex xs12 md6>
                <v-select
           ...
           <v-flex xs12 md2 text-xs-right>
            ...
            <v-flex xs12 md2>
                <div>
                  ...
                  <span class="color-text" style="fontSize:18px">
 ...
 <v-flex xs12 md4>
                <div>
                  <div class="yellow color-box"
                      style="boxShadow: 0px 0px 2px 2px #ffeb3b !important;"></div>
                  <span class="color-text" style="fontSize:18px">
                      مكاتبات للمتابعة ولم يتم الرد من الفرع المختص
                  </span>
                </div>
              </v-flex>              
              <v-flex xs12 md3>
            ...
            <template slot="items" slot-scope="{ item }">
              ...
              >
                ...
                >
                  ...
                  <template
                    v-else-if="['subject', 'decision'].includes(header.value)"
                  >
                    <span
